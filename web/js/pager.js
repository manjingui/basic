...
var sjPager = window.sjPager = {
    ...
    pagerElement: null,
    commonHtmlText: {
        spanHtml: "<span style='padding-left: 5px;' class='{0}'>{1}</span>",
        pageIndexHtml: "<a style='padding-left: 5px;' href='javascript:void(0)' onclick='sjPager.doPage({0},{1},{2})'>{3}</a>",
        rightHtml: "<span style='padding-left: 5px;' class='text'> &nbsp; 共 {0} 页， 到第</span> <input style='width: 40px;' type='text' id='txtToPager' value={1} /><span class='text'>页</span> <button id='btnJump' onclick='sjPager.jumpToPage();return false;' >跳转</button>",
